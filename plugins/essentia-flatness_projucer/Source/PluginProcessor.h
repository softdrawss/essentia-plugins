...
public:
    ...
    float getFlatness() const { return flatnessValue; }

private:
    essentia::standard::Algorithm* windowing  = nullptr;
    essentia::standard::Algorithm* spectrum   = nullptr;
    essentia::standard::Algorithm* flatness   = nullptr;

    essentia::Real flatnessValue { 0.0f };
    std::vector<essentia::Real> essentiaBuffer;
    std::vector<essentia::Real> windowedBuffer;
